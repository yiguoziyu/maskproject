...
/**
 * Created by 一锅子鱼 on 2019/1/26.
 */
public class IClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public IClassicsFooter(Context context) {
        this(context, null);
    }

    public IClassicsFooter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (REFRESH_FOOTER_NOTHING == null) {
            REFRESH_FOOTER_NOTHING = context.getString(R.string.footer_loading);
        }
