...
/**
 * Created by 一锅子鱼 on 2018/12/19.
 */
public class IClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public IClassicsHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public IClassicsHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public IClassicsHeader setTimeFormat(DateFormat format) {
    ...
    public IClassicsHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
    ...
    public IClassicsHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public IClassicsHeader setTextSizeTime(float size) {
...
//    }
    ...
    public IClassicsHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
