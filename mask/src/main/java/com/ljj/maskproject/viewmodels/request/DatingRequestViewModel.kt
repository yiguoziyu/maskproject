...
class DatingRequestViewModel : BaseViewModel() {
    ...
    private val _datingEnrolls by lazy { MutableLiveData<String>() }
    val datingEnrolls get() = _datingEnrolls

    private val _datingAudit by lazy { MutableLiveData<String>() }
    ...
    fun datingEnrolls(dating_id: String) {
        launchWithLoading({
            ...
            _datingEnrolls.value = dating_id
        })
    }
    ...
    fun datingCheckCanPublish() {
        launch({
            ...
            _datingCheckCanPublish.value = it
        })
    }
}